...
object DialogUtils {
    ...
    fun showInlineResult(
        ...
        val messageView = rootView.findViewById<TextView?>(R.id.messageTextView)
        val gifView = rootView.findViewById<ImageView?>(R.id.gifImageView)

        if (overlay != null && messageView != null && gifView != null) {
            Log.d("DialogUtils", "Showing INLINE result")
            ...
            Log.d("DialogUtils", "Showing DIALOG result (inline views not present)")
